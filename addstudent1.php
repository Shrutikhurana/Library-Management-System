...
<br><br><br>
 <div class="panel panel-warning">
            <div class="panel-heading">
             <center> <h3 class="panel-title">Please enter the details of the student to be added</h3></center>
            </div>
 </div>
...
<span class="error"><?php  echo $_SESSION["anamerr"]; ?></span>
<br><br>
<p class="text-danger">Enter the Membership Type</p>
<input type="text" name="type" placeholder="Membership Type">
<span class="error"><?php  echo $_SESSION["atyperr"]; ?></span>

<br><br>
<p class="text-danger">Enter the student address</p>
<input type="text" name="address" placeholder="Address">
<span class="error"><?php  echo $_SESSION["aaddresserr"]; ?></span>
