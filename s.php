...
if ($result->num_rows > 0)
 {
   	 echo "<table border='1' ><tr><th>MEMBER ID</th><th>NAME</th><th>MEMBERSHIP DATE</th><th>EXPIRY</th><th>MEMBERSHIP TYPE</th><th>LIMIT BOOK</th><th>ADDRESS</th></tr>";
   	 // output data of each row
  	  while($row = $result->fetch_assoc()) {
  
       	 echo "<tr ><td>".$row["memid"]."</td><td>".$row["sname"]."</td><td>".$row["memdate"]."</td><td>".$row["expiry"]."</td><td>".$row["memtype"]."</td><td>".$row["limit_book"]."</td><td>".$row["address"]."</td></tr>";
