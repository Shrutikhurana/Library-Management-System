...
<center><h3><b><u>Please enter the details for the book to be returned</h3></b></u></center>

<br><br>
<center><p class="text-danger">Enter the bookID</p>
<input type="text"name="bookid" placeholder="BOOK ID">
<span  class="error"><?php echo $_SESSION["rtitleerr"]; ?></span>
...
<!--for return perform the appropriate changes in the table--> 
<!-- borrow.php should display books(bookid, title, groupid, available, maxbook, price),student(memid, sname, memdate, expiry, memtype, limit_book) after book return-->

<button type="submit" class="btn btn-warning btn-lg">Return book</button>
</center>
