...
<br><br><br>
 <div class="panel panel-warning">
            <div class="panel-heading">
             <center> <h3 class="panel-title">Please enter the details of the student to be deleted</h3></center>
            </div>
 </div>

<form action="deletestudent.php" method="post">

<center><p class="text-danger">Enter the Membership ID</p>
<input type="text" name="memid" placeholder="Membership ID">
<span class="error" ><?php echo $_SESSION["dsmemerr"]; ?></span>
...
<center>
<button type="submit" class="btn btn-warning btn-lg">Delete Student</button>
</center>
