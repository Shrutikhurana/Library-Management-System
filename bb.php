...
if ($result->num_rows > 0)
 {
   	 echo "<table border='1' ><tr><th>ISSUE DATE</th><th>RETURN DATE</th><th>FINE</th><th>BOOKID</th><th>MEMID</th></tr>";
   	 // output data of each row
  	  while($row = $result->fetch_assoc()) {
  
       	 echo "<tr ><td>".$row["issuedate"]."</td><td>".$row["returndate"]."</td><td>".$row["fine"]."</td><td>".$row["bookid"]."</td><td>".$row["memid"]."</td></tr>";
