...
<br><br><br>
 <div class="panel panel-warning">
            <div class="panel-heading">
             <center> <h3 class="panel-title">Please enter the details of the student records to be modified</h3></center>
            </div>
 </div>

<form action="modifystudent1.php" method="post">
<center><p class="text-danger">Enter the Membership ID</p>
<input type="text" name="memid" placeholder="Membership ID">
<span class="error"><?php echo $_SESSION["msmemerr"]; ?></span>
</center>
<br><br><br>
<center>
